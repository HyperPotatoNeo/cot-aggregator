...
if __name__ == "__main__":
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            fn_name = question.split('def ')[-1].split('(')[0]
            test_cases = example.pop("test")
            test_cases = extract_assert_lines(test_cases)
            test_cases = [r.replace(' candidate(', f' {fn_name}(') for r in test_cases]

            question = "Write a Python function implementation for the following:\n\n" + question
            data = {
